            ...
            <header class="text-center mb-16 relative z-10">
                <div class="inline-block relative">
                    ...
                    <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mt-8">
                        Plataforma integral de gestión y análisis de datos
                    </p>
                </div>
            </header>
            ...
            <section class="mb-24 relative z-10">
                <div class="text-center mb-16">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mt-6 text-xl leading-relaxed">
                        Tecnología que transforma: desarrollo de sistemas digitales modernos y adaptados a tus necesidades.
                    </p>
                </div>

                <!-- Grid de módulos con diseño alternado -->
            ...
            <section class="mb-20 relative z-10">
                ...
                <div class="max-w-3xl mx-auto">
                    <div class="bg-linear-to-br from-white/90 to-blue-50/90 dark:from-gray-800/90 dark:to-gray-900/90 backdrop-blur-xl rounded-[2.5rem] shadow-2xl p-12 text-center border border-gray-100/50 dark:border-gray-700/50 relative overflow-hidden group">
                        ...
                        <h3 class="text-3xl font-black text-gray-800 dark:text-white mb-6 relative z-10">Soporte Técnico Especializado</h3>
...
const modules = ref<Module[]>([
    {
        id: 1,
        title: 'Anexos',
        description: 'Lista de anexos telefónicos',
        icon: 'pi pi-users',
        color: '#6f42c1',
        path: '/main/anexos',
        status: 'enabled'
        ...
        id: 2,
        title: 'Cumpleaños',
        description: 'Recordatorio y gestión de fechas de cumpleaños del personal',
        icon: 'pi pi-gift',
        color: '#e91e63',
        path: '/main/birthday',
        status: 'enabled'
    },
      {
        id: 3,
        title: 'Ipress',
        description: 'Listado de establecimientos de salud',
        icon: 'pi pi-gift',
        color: '#79792E',
        path: '/main/ipress',
        status: 'enabled'
    },
    {
        ...
        description: 'Seguimiento de registros de reuniones',
        icon: 'pi pi-book',
        color: '#ffb300',
        path: 'https://app.powerbi.com/view?r=eyJrIjoiNGY5NjM1ZWMtODg3ZC00OGUyLWE2YjAtZGIwN2Q3OTU3MTllIiwidCI6Ijc5MDVjMWZjLTkzM2MtNDUyYS04YjgzLWIyZTU2NDU1ZDE2YSIsImMiOjR9',
        status: 'coming-soon',
        type: 'powerbi'
    },
    {
        ...
        description: 'Control de salidas y vehículos',
        icon: 'pi pi-car',
        color: '#0B5ED7',
        path: '/dashboard',
        status: 'coming-soon'  //estados enabled, disabled, maintenance, coming-soon
    },
])
