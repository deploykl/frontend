...
const modules = ref<Module[]>([
     {
        id: 1,
        title: 'DPK',
        description: 'Distribución de equipos de DPCAN Periodo : 2023 - 2024 ',
        icon: 'pi pi-chart-line',
        color: '#1397A5',
        path: 'https://app.powerbi.com/view?r=eyJrIjoiOWUzZmZkMmQtNDA0ZS00NzkxLWE2ZjUtMjIwZWNjZmVjYTZjIiwidCI6Ijc5MDVjMWZjLTkzM2MtNDUyYS04YjgzLWIyZTU2NDU1ZDE2YSIsImMiOjR9',
        status: 'enabled',
        type: 'powerbi'
    },
    {
        id: 2,
        title: 'Tablero SGD',
        description: 'Reporte de Pendientes',
