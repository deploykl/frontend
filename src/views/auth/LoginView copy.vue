<template>
    <div class="min-h-screen bg-linear-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-slate-900 flex items-center justify-center p-4">
        ...
        <div class="w-full max-w-md bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl dark:shadow-black/30 overflow-hidden border border-white/20 dark:border-gray-700/30 animate-fade-in">
            ...
            <div class="p-8 lg:p-10">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <button @click="handleBackToHome" 
                            class="group relative p-3 rounded-2xl hover:bg-white/60 dark:hover:bg-gray-700/60 
