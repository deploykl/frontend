<template>
    <div
        ...
        <div
            class="w-full max-w-5xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl dark:shadow-black/30 overflow-hidden border border-white/20 dark:border-gray-700/30 animate-fade-in">
            <div class="flex flex-col lg:flex-row h-full">
                <!-- Sección lateral izquierda - Imagen y branding -->
                <div
                    class="hidden lg:flex lg:w-2/5 relative overflow-hidden bg-linear-to-br from-indigo-600 via-cyan-600 to-blue-700">
                    <!-- Patrón de fondo sutil -->
                    <div class="absolute inset-0 bg-grid-white/[0.02] bg-size-[60px_60px]"></div>

                    <!-- Efectos de gradiente animados -->
                    <div class="absolute top-0 left-0 w-72 h-72 bg-purple-500/20 rounded-full blur-3xl animate-pulse">
                    </div>
                    <div
                        class="absolute bottom-0 right-0 w-72 h-72 bg-blue-500/20 rounded-full blur-3xl animate-pulse delay-1000">
                    </div>
                    ...
                    <div class="relative z-10 flex flex-col justify-between p-12 h-full">
                        ...
                        <div class="flex justify-start mb-4">
                            <button @click="handleBackToHome"
                                class="cursor-pointer flex items-center space-x-2 px-4 py-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-xl border border-white/20 text-white transition-all duration-300 hover:scale-105 group">
                                <i
                                    class="pi pi-arrow-left group-hover:-translate-x-1 transition-transform duration-300 "></i>
                        ...
                        <div class="flex-1 flex flex-col justify-center">
                            ...
                            <div class="text-center mb-8">
                                <div
                                    class="inline-flex items-center justify-center w-16 h-16 bg-white/10 rounded-2xl backdrop-blur-sm border border-white/20 mb-6">
                                    <i class="bi bi-shield-lock text-white text-4xl"></i>
                                </div>
                                <h1 class="text-3xl font-bold text-white mb-3 tracking-tight">
                                    PORTAL UNIFICADO <br>DIGITAL
                                </h1>
                                <p class="text-blue-100 text-lg font-light">Acceso Único a Herramientas y Servicios
                                    Digitales</p>
                            </div>
                            ...
                            <div class="space-y-4">
                                <div
                                    class="flex items-center space-x-4 p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10">
                                    <div
                                        class="shrink-0 w-10 h-10 bg-green-500/20 rounded-lg flex items-center justify-center">
                                        <i class="pi pi-verified text-green-300"></i>
                                    </div>
                                    <div>
                                        <p class="text-white font-medium">Acceso Unificado</p>
                                        <p class="text-blue-200 text-sm">Todos los sistemas en un solo lugar</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    class="flex items-center space-x-4 p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10">
                                    <div
                                        class="shrink-0 w-10 h-10 bg-blue-500/20 rounded-lg flex items-center justify-center">
                                        <i class="pi pi-th-large text-green-300"></i>
                                    </div>
                                    <div>
                                        <p class="text-white font-medium">Módulos Especializados</p>
                                        <p class="text-blue-200 text-sm">Soluciones para cada área institucional</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 p-4 bg-yellow-500/20 backdrop-blur-sm rounded-xl border border-yellow-400/30">
                            <div class="flex items-start space-x-3">
                                <div
                                    class="shrink-0 w-6 h-6 bg-yellow-500 rounded-full flex items-center justify-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-yellow-100 text-xs mt-1 leading-relaxed">
                                        Integrando soluciones para optimizar procesos y la toma de decisiones
                                        estratégicas.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="w-full lg:w-3/5 p-8 lg:p-12">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <!-- Botón de regreso al home (solo en móvil) -->
                        <button @click="handleBackToHome"
                            class="lg:hidden flex items-center space-x-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-xl text-gray-700 dark:text-gray-300 transition-all duration-300 hover:scale-105 group">
                            <i
                                class="pi pi-arrow-left group-hover:-translate-x-1 transition-transform duration-300"></i>
                    ...
                    <div class="lg:hidden mb-8 text-center">
                        ...
                        <!-- Badge móvil -->
                        <div
                            class="mt-4 p-3 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg border border-yellow-200 dark:border-yellow-800">
                            <div class="flex items-center space-x-2">
                                <i class="pi pi-info text-yellow-600 dark:text-yellow-400"></i>
                                <span class="text-yellow-800 dark:text-yellow-200 text-xs font-medium">PLATAFORMA EN
                                    DESARROLLO</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div v-if="authStore.remainingAttempts !== null && authStore.remainingAttempts > 0"
                                ...
                                <div class="flex items-center space-x-3">
                                    <div
                                        ...
                                        <i
                                            class="pi pi-exclamation-triangle text-amber-600 dark:text-amber-400 text-sm"></i>
                                    </div>
                                    <div class="flex-1">
                                        <p class="text-amber-800 dark:text-amber-200 text-sm font-medium">
                                            Intentos restantes:
                                            <span
                                                class="bg-amber-600 text-white px-2 py-1 rounded-full text-xs font-bold ml-2">
